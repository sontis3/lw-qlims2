<template>
  <div>
    ...
    <q-dialog v-model="showDialog" no-backdrop-dismiss>
      <q-card>
        <q-card-section>
          <div class="text-h6">Добавление нового Действия над Системным объектом</div>
        </q-card-section>
        <q-card-section>
...
export default {
  ...
  computed: {
    ...mapState({
      ds: state => state.ds.dsSystemObjectsActions,        // источник данных
  ...
  methods: {
    ...
    ...mapActions({
      getDocuments: 'ds/getSystemObjectsActions',
      addDocument: 'ds/addSystemObjectAction',
      deleteDocument: 'ds/deleteSystemObjectAction',
      updateDocument: 'ds/updateSystemObjectAction',
    }),
